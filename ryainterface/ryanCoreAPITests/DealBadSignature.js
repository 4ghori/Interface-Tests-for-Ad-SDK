(function() {
    ...
    var myTestData = dealTestData.invalidDealSignature[0];
    ...
    setValues({ "initializeCallback": function(testState) {
                    ...
                    myRyCore.registerPostEventHandler(RYANCore.HDESTROY,dealFailure,myRyCore);
                ...
                "preInitializationCallback": function(testCount) {
                    myTestData = dealTestData.invalidDealSignature[ testCount - 1 ];
                    _adObject.placeguid = myTestData.placeguid;
                    _adObject.lib = { deal : myTestData.deal };
                },
                "testName":"Deal Bad Signature",
                "AdObject": _adObject,
                "customLoad" : loadDeal,
                "runNumOfTimes":dealTestData.invalidDealSignature.length,
                "maxRuntime":45000
                });
